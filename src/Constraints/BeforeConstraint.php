    ...
    public function canSend(MailatorSchedule $schedule, Collection $logs): bool
    {
        ...
        if ($schedule->toDays() > 0) {
            ...
            return $schedule->isOnce()
                ...
                : $schedule->timestampTarget()->diffInDays(now()->floorSeconds(), absolute: true) < $schedule->toDays();
        }
        ...
        if ($schedule->toHours() > 0) {
            ...
            return $schedule->isOnce()
                ...
                : $schedule->timestamp_target->diffInHours(now()->floorSeconds(), absolute: true) < $schedule->toHours();
        }
